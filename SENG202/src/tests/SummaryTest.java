...
public class SummaryTest extends TestCase {
	...
	/**
	 * checks that the constructor is correctly identifying the events between
	 * the start and end date
	 * 
	 * @throws ParseException
	 */
	public void testSummary() throws ParseException {
		Calendar startDate = new Calendar.Builder().setInstant(
				sdf.parse("10/04/2005")).build();
		Calendar endDate = new Calendar.Builder().setInstant(
				sdf.parse("12/04/2005")).build();
